...
import { createPost, getCategories, PostFormData, Category } from '@/api/community.api'; // Adjusted path
...
const NewPost: React.FC = () => {
  ...
  const redirectPath = `/${contentMode}/community`;
  ...
  const { mutate: submitPost, isPending, isError } = useMutation({
