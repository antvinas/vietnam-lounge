// src/pages/MyPage/MyPageHome.tsx
import { useState } from "react";
import Settings from "./Settings";
import MyFavorites from "./MyFavorites";
import MyCoupons from "./MyCoupons";
import { FaUser, FaHeart, FaTicketAlt } from "react-icons/fa";

const MyPageHome = () => {
  const [activeTab, setActiveTab] = useState<"settings" | "my-favorites" | "my-coupons">("settings");
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">{renderContent()}</main>
      </div>
    </div>
  );
};
